...
const Profile = () => {
  ...
  // if (loading) {
  //   return (
  //     <div className='w-full min-h-screen flex flex-col items-center justify-center bg-gray-950 text-white'>
  //       <div className='text-orange-600 font-bold text-3xl'>Loading...</div>
  //     </div>
  //   );
  // }
  if (loading){
  ...
  return (
    <div className='w-full min-h-screen flex flex-col items-center md:gap-10 bg-gray-950 px-4 md:px-10 pt-20 text-white'>
      ...
      {blogs.length === 0 && (
        <Link to="/create-post">
            <div className='w-fit border-2 p-2 font-bold text-orange-700 bg-black  cursor-pointer'>
           
            <p className='font-bold text-lg my-2 '>Click here to Create posts</p>
          </div>
        </Link>
      )}
